...
public static function obtener_facturas_filtradas($conexion,$criterio){
    ...
    public static function obtener_numero_compras($conexion,$mes){
        if (isset($conexion)){ 
        $compras = "";
        
        try{
                
                $sql = 'select count(cod_factura_compra) from facturas_compra where fecha LIKE "%'.$mes. '%"' ;
    ...
    public static function obtener_grafica_compras($conexion){
        if (isset($conexion)){ 
        $compras = "";
    
        try{
                
        $compras = new C_PhpChartX(array(array(
                repositorio_factura::obtener_numero_compras(Conexion::obtenerConexion(),"-09-"), 
                repositorio_factura::obtener_numero_compras(Conexion::obtenerConexion(),"-10-"), 
                repositorio_factura::obtener_numero_compras(Conexion::obtenerConexion(),"-11-"), 
                repositorio_factura::obtener_numero_compras(Conexion::obtenerConexion(),"-12-"), 
                repositorio_factura::obtener_numero_compras(Conexion::obtenerConexion(),"-01-"))),
                'basic_chart2','chart7');
    ...
    public static function obtener_egresos($conexion,$mes){
        ...
        try{
                ...
                $sql = 'select sum(total) from facturas_compra where fecha LIKE "%'.$mes. '%"' ;
...
/* OBTIENE EL GRAFICO HAY QUE HACER QUE ESTO SEA GENERICO */
    public static function obtener_grafica_egresos($conexion/* ,$mes_inicio */){
        ...
        try{
            ...
            $total->set_title(array('text'=>'Ultimos cinco meses'));
