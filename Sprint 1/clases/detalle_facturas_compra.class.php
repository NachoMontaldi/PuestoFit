...
class detalle_facturas_compra {

    private $cod_det_factura_compra;
    ...
    //Constructor 
    public function __construct($cod_det_factura_compra,$cod_factura_compra,
    $nombre,$marca,$cantidad,$precio_unitario){
        $this -> cod_det_factura_compra =$cod_det_factura_compra;
    ...
    //Getters
    public function obtener_cod_det_factura_compra() {
        return $this -> cod_det_factura_compra;
    }
