<!DOCTYPE html>
  ...
  <head>
    <title>Detalle Factura Ventas</title>
  ...
  <body>
    ...
    <div id="formulario" class="form">
      <table class="tabla" border="1px">
        <tr>
          <td colspan="4" class="titulo">DETALLE VENTA</td>
        </tr>
        <tr>
              ...
              <table class="table-hover table table-bordered grilla">
                ...
                <tbody>
                  <tr>
                    <?php
                    if (isset($_POST['ver_detalle'])) {
                      escritor_ventas::escribir_detalles_venta($_POST['ver_detalle']);
                    } ?>
                  </tr>
                  <tr>
