...
<body>
                            ...
                            <table id="grilla" class="table-hover table table-bordered">
                                <thead class="thead-dark">
                                    ...
                                    if (isset($_POST['busqueda'])) {
                                        ...
                                        escritor_ventas::escribir_productos_filtrados_sel($criterio);
                                    } else {

                                        escritor_ventas::escribir_productos_sel();
    ...
    <div class="contenedor4">
        <a href="<?php echo ruta_registrar_detalle_venta ?>"><button name="volver" id="volver">VOLVER</button></a>
    </div>
</body>
