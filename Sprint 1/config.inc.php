...
define('ruta_agregar_producto_pedido',servidor.'/pantallas/agregar_producto_pedido.php');
...
define('ruta_registrar_detalle_movimiento',servidor.'/pantallas/registrar_detalle_movimiento.php');
...
define('ruta_grafico_informes_ventas',servidor.'/pantallas/grafico_informes_ventas.php');
